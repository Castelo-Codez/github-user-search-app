...
const $dark = window.localStorage.getItem("theme") ? ref(true) : ref(false);
...
<template>
    <header class="pt-[150px] flex justify-between items-center">
        <a
            class="text-LighttxtHighContrast dark:text-darktxtHighContrast text-[30px]"
        >
            devfinder
        </a>
        <button class="uppercase tracking-[2.5px]" @click="changeTheme">
            <div
                class="Light align-middle text-[14px] gap-x-[20px] hidden dark:flex text-LighttxtLowContrast dark:text-darktxtLowContrast"
            >
                Light
                <span class="icon">
                    <svg
            ...
            <div
                class="dark flex align-middle text-[14px] gap-x-[20px] dark:hidden text-LighttxtLowContrast dark:text-darktxtLowContrast"
            >
                Dark
                <span class="icon">
                    <svg
